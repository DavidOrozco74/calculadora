...
type Inputs = {
  ...
  otherInvestorsOwnership: number;
  fundingNeeded: number;
  vcPercentage: number;
  ventureDebtPercentage: number;
  ventureDebtInterestRate: number;
  ventureDebtTerm: number;
  warrantCoverage: number;
  exitMultiple: number;
  showHybridOption: boolean; // boolean for toggling
};
...
function App() {
  ...
  const [inputs, setInputs] = useState<Inputs>({
    companyValuation: 0,
    founderOwnership: 0,
    otherInvestorsOwnership: 0,
    fundingNeeded: 0,
    vcPercentage: 0,
    ventureDebtPercentage: 0,
    ventureDebtInterestRate: 0,
    ventureDebtTerm: 0,
    warrantCoverage: 0,
    exitMultiple: 0,
  ...
  useEffect(() => {
    ...
    if (inputs.showHybridOption) {
      // Si ambos campos tienen valores, habilitamos el botón
      setIsButtonEnabled(
        inputs.vcPercentage > 0 && inputs.ventureDebtPercentage > 0
      );
    } else {
      // Si el checkbox no está activado, habilitamos el botón por defecto
  ...
  return (
        ...
        <div className="bg-white p-6 rounded-lg shadow-md col-span-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={displayInputs.companyValuation}
                  placeholder={`${placeholder.companyValuation.toLocaleString(
                    "en-US"
                  )}`}
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-black">
                Founder Ownership (%)
                {((formSubmitted && inputs.founderOwnership === 0) ||
                  isNaN(inputs.founderOwnership)) && (
                  <span className="text-red-500 ml-2">Required</span>
                )}
              </label>
              <div className="relative">
                <input
                  type="number"
                  name="founderOwnership"
                  value={displayInputs.founderOwnership}
                  placeholder={placeholder.founderOwnership.toString()}
                  onChange={handleInputChange}
                  className={`w-full pl-7 p-2 border ${
                    formSubmitted && inputs.companyValuation === 0
                      ? "border-red-500"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-black">
                Funding Needed ($)
                {((formSubmitted && inputs.fundingNeeded === 0) ||
                  isNaN(inputs.fundingNeeded)) && (
                  <span className="text-red-500 ml-2">Required</span>
                )}
              </label>
              <div className="relative">
                ...
                <input
                  type="text"
                  name="fundingNeeded"
                  value={displayInputs.fundingNeeded}
                  onChange={handleInputChange}
                  placeholder={placeholder.fundingNeeded.toLocaleString(
                    "en-US"
                  )}
                  className={`w-full pl-7 p-2 border ${
                    formSubmitted && inputs.companyValuation === 0
                ...
                <div className="flex items-center space-x-2">
                  <div className="flex-1">
                    <label className="text-sm font-medium text-black">
                      ...
                      {formSubmitted &&
                        inputs.showHybridOption &&
                        (inputs.vcPercentage === 0 ||
                          isNaN(inputs.vcPercentage)) && (
                          <span className="text-red-500 ml-2">Required</span>
                        )}
                    </label>
                    <div className="relative">
                  ...
                  <div className="flex-1">
                    <label className="text-sm font-medium text-black">
                      ...
                      {formSubmitted &&
                        inputs.showHybridOption &&
                        (inputs.ventureDebtPercentage === 0 ||
                          isNaN(inputs.ventureDebtPercentage)) && (
                          <span className="text-red-500 ml-2">Required</span>
                        )}
                    </label>
                    <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-black">
                ...
                {((formSubmitted && inputs.ventureDebtInterestRate === 0) ||
                  isNaN(inputs.ventureDebtInterestRate)) && (
                  <span className="text-red-500 ml-2">Required</span>
                )}
              </label>
              <div className="relative">
                <input
                  ...
                  value={displayInputs.ventureDebtInterestRate}
                  onChange={handleInputChange}
                  placeholder={placeholder.ventureDebtInterestRate.toString()}
                  className={`w-full pl-7 p-2 border ${
                    formSubmitted && inputs.companyValuation === 0
                      ? "border-red-500"
                      : "border-gray-300"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-black">
                Term Length (Months)
                {((formSubmitted && inputs.ventureDebtTerm === 0) ||
                  isNaN(inputs.ventureDebtTerm)) && (
                  <span className="text-red-500 ml-2">Required</span>
                )}
              </label>
              <div className="relative">
                <input
                  ...
                  value={displayInputs.ventureDebtTerm}
                  placeholder={placeholder.ventureDebtTerm.toString()}
                  onChange={handleInputChange}
                  className={`w-full pl-7 p-2 border ${
                    formSubmitted && inputs.companyValuation === 0
                      ? "border-red-500"
            ...
            <div className="md:col-span-1 space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  value={displayInputs.warrantCoverage}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-black">
                Exit Valuation ($)
                {formSubmitted && inputs.exitMultiple === 0 && (
                  <span className="text-red-500 ml-2">Required</span>
                )}
              </label>
              <input
                type="text"
                name="exitMultiple"
                value={displayInputs.exitMultiple}
                onChange={handleInputChange}
                placeholder={placeholder.exitMultiple.toLocaleString("en-US")}
                className={`w-full pl-7 p-2 border ${
                  formSubmitted && inputs.companyValuation === 0
                    ? "border-red-500"
                    : "border-gray-300"
    ...
    transition-all 
    duration-300
    ${isHovered ? "bg-blue-700 shadow-md scale-[1.02]" : ""}
  `}
            ...
            <div className="flex flex-col items-center bg-gray-100 p-4 mb-4 rounded-lg w-full">
              ...
              <div className="w-full max-w-2xl">
                <ResponsiveContainer width="100%" height={350}>
                  <PieChart
                    margin={{ top: 100, right: 10, bottom: 70, left: 10 }}
                  >
                    <Pie
            ...
            <div className="grid grid-cols-1  gap-6">
                ...
                <ul className="space-y-3 text-sm">
                  {(results.ownershipDifference ?? 0) > 0 ? (
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        In this scenario, venture debt does not provide
                        significant equity preservation benefits.
                      </span>
                    </li>
                  )}
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      {results.debtWarrantDilution.toFixed(1)}%, compared to
                      venture capital dilution of{" "}
                      {results.vcDilution.toFixed(1)}%.
                    </span>
                  </li>
                  ...
                  (results.exitValueDifference ?? 0) ? (
                    <li className="flex items-start">
                      ...
                      <span>
                        ...
                        {formatCurrency(results.exitValueDifference)}, making
                        debt financially advantageous.
                      </span>
                    </li>
                  ) : (
                    <li className="flex items-start">
                      ...
                      <span>
                        Total cost of debt of{" "}
                        {formatCurrency(results.totalInterestPayments)} may
                        offset some of the equity preservation benefits.
                      </span>
                    </li>
                  )}
                  ...
                  <li className="flex items-start ">
                    <span className="text-[#0057FF] mr-2">■</span>
                    <span>
                      Venture debt is ideally suited for companies with:
                    </span>
                  </li>
                  ...
                  <ul className="ml-6 space-y-2 border-b border-gray-200 pb-2">
                    ...
                    <li className="flex items-start">
                      <span className="text-gray-500 mr-2">○</span>
                      <span>
                        Clear path to additional funding or profitability
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-gray-500 mr-2">○</span>
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      predetermined price, typically based on the company's
                      latest valuation. For example, on a $10M loan with 10.0%
                      warrant coverage, the lender would receive warrants to buy
                      $1M worth of equity today at the agreed price.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#000000] mr-2">■</span>
                    <span>
                      Note: Assumes {inputs.ventureDebtTerm} months of
                      amortization.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-gray-100 p-5 rounded-lg">
                ...
                <span className="flex items-start text-sm">
                  This tool is for general informational purposes only and does
                  not constitute legal, financial, or other professional advice.
                  We make no warranties or representations of any kind, express
                  or implied, regarding its accuracy, completeness, or
                  reliability, as it is intended for estimation purposes only.
                  We are not responsible for any actions taken or decisions made
                  in reliance of this tool or the resulting calculations.
                </span>
              </div>
            </div>
          </div>
